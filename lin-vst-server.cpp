...
bool retval;
        ...
        tryWrite(&m_shm[FIXED_SHM_SIZE - sizeof(VstPinProperties)], &ptr, sizeof(VstPinProperties));
...
bool retval;
        ...
        tryWrite(&m_shm[FIXED_SHM_SIZE - sizeof(MidiKeyName)], &ptr, sizeof(MidiKeyName));
...
bool retval;
        ...
        tryWrite(&m_shm[FIXED_SHM_SIZE - sizeof(MidiProgramName)], &ptr, sizeof(MidiProgramName));
...
bool retval;
        ...
        tryWrite(&m_shm[FIXED_SHM_SIZE - sizeof(MidiProgramCategory)], &ptr, sizeof(MidiProgramCategory));
...
bool retval;
       ...
       tryRead(&m_shm[FIXED_SHM_SIZE - sizeof(VstSpeakerArrangement)], &value, sizeof(VstSpeakerArrangement));
...
#endif
{
  ...
  //  remoteVSTServerInstance->writeIntring(&remoteVSTServerInstance->m_shmControl->ringBuffer, value);
    ...
    if (!remoteVSTServerInstance->exiting && remoteVSTServerInstance->effectrun)
    {
        if(remoteVSTServerInstance->aeffectio)
        memcpy(remoteVSTServerInstance->aeffectio, plugin, sizeof(AEffect));
