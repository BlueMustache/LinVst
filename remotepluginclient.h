...
public:
    ...
    int                 getInputCount(int);
    int                 getOutputCount(int);
    int                 getFlags();
    int                 getinitialDelay();
    ...
    bool                getEffInProp(int index, char *ptr);
    bool                getEffOutProp(int index, char *ptr);
    bool                getEffMidiKey(int index, char *ptr);
    bool                getEffMidiProgName(int index, char *ptr);
    bool                getEffMidiCurProg(int index, char *ptr);
    bool                getEffMidiProgCat(int index, char *ptr);
    bool                getEffMidiProgCh(int index);
    bool                setEffSpeaker(long value, char *ptr);
    bool                getEffSpeaker(long value, char *ptr);
