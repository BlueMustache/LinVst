...
bool RemotePluginClient::getEffInProp(int index, char *ptr)
{
...
bool b;
    ...
    tryRead(&m_shm[FIXED_SHM_SIZE], &b, sizeof(bool));
    tryRead(&m_shm[FIXED_SHM_SIZE - sizeof(VstPinProperties)], &ptr2, sizeof(VstPinProperties));
    memcpy(ptr, &ptr2, sizeof(VstPinProperties));

    return b;
}

bool RemotePluginClient::getEffOutProp(int index, char *ptr)
{
VstPinProperties ptr2;
bool b;
...
bool RemotePluginClient::getEffMidiKey(int index, char *ptr)
{
MidiKeyName ptr2;
bool b;
    ...
    tryRead(&m_shm[FIXED_SHM_SIZE], &b, sizeof(bool));
    tryRead(&m_shm[FIXED_SHM_SIZE - sizeof(MidiKeyName)], &ptr2, sizeof(MidiKeyName));
    memcpy(ptr, &ptr2, sizeof(MidiKeyName));

    return b;
}

bool RemotePluginClient::getEffMidiProgName(int index, char *ptr)
{
...
bool b;
    ...
    tryRead(&m_shm[FIXED_SHM_SIZE], &b, sizeof(bool));
    tryRead(&m_shm[FIXED_SHM_SIZE - sizeof(MidiProgramName)], &ptr2, sizeof(MidiProgramName));
    memcpy(ptr, &ptr2, sizeof(MidiProgramName));
    
    return b;
}

bool RemotePluginClient::getEffMidiCurProg(int index, char *ptr)
{
MidiProgramName ptr2;
bool b;
...
bool RemotePluginClient::getEffMidiProgCat(int index, char *ptr)
{
...
bool b;
    ...
    tryRead(&m_shm[FIXED_SHM_SIZE], &b, sizeof(bool));
    tryRead(&m_shm[FIXED_SHM_SIZE - sizeof(MidiProgramCategory)], &ptr2, sizeof(MidiProgramCategory));
...
bool RemotePluginClient::setEffSpeaker(long value, char *ptr)
{
bool b;

    tryWrite(&m_shm[FIXED_SHM_SIZE - (sizeof(VstSpeakerArrangement)*2)], ptr, sizeof(VstSpeakerArrangement));
    tryWrite(&m_shm[FIXED_SHM_SIZE - sizeof(VstSpeakerArrangement)], (char *)value, sizeof(VstSpeakerArrangement));
...
bool RemotePluginClient::getEffSpeaker(long value, char *ptr)
{
bool b;
    ...
    tryRead(&m_shm[FIXED_SHM_SIZE - ( sizeof(VstSpeakerArrangement)*2)], ptr, sizeof(VstSpeakerArrangement));
   tryRead(&m_shm[FIXED_SHM_SIZE - sizeof(VstSpeakerArrangement)], (char *)value, sizeof(VstSpeakerArrangement));
...
int RemotePluginClient::getOutputCount(int update)
{
